...
###
findVal = line.find(marker)
ending = line[findVal + len(marker):]
starting = line[0: findVal]
replaced = starting + replacement +ending

print(replaced)
'''
 A simple way to replace a word in a line in python 
getMarker= line.find(marker)
